...
(the configured proposers, by default Gemini Pro + Grok + GLM) and Layer 2 (the
...
**Proposers**: <the resolved proposer roster, e.g. agy-gemini-pro (gemini-3.1-pro-high), grok (grok-4.5), glm (glm-5.2)>
...
<substantive disagreements across the proposers (e.g. Gemini Pro / Grok / GLM),
