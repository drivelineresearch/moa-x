...
configured broadcast refiners, by default codex-sol + qwen). The
...
**Proposers**: <the resolved proposer roster, e.g. codex (gpt-5.6-terra high), glm (glm-5.2), sonnet (claude-sonnet-5 high)>
**Refiners**: <the resolved refiner roster, e.g. codex-sol (gpt-5.6-sol high), qwen (qwen3.8-max-preview; broadcast)>
