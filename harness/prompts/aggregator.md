...
(the configured proposers, by default Gemini Pro + Terra + Sonnet) and Layer 2 (the
configured broadcast refiners, by default qwen + opus). The
...
**Proposers**: <the resolved proposer roster, e.g. agy-gemini-pro (gemini-3.1-pro-high), codex (gpt-5.6-terra high), sonnet (claude-sonnet-5 high)>
**Refiners**: <the resolved refiner roster, e.g. qwen (qwen3.8-max-preview; broadcast), opus (claude-opus-5 high; broadcast)>
...
<substantive disagreements across the proposers (e.g. Gemini Pro / Terra / Sonnet),
