...
(the configured proposers, e.g. codex + glm + sonnet) and Layer 2 (the
configured broadcast refiners, by default codex-reviewer + qwen). The
...
**Proposers**: <the resolved proposer roster, e.g. codex (gpt-5.6-terra high), glm (glm-5.2), sonnet (rolling alias)>
**Refiners**: <the resolved refiner roster, e.g. codex-reviewer (gpt-5.6-sol high), qwen (qwen3.8-max-preview; broadcast)>
